    ...
    public function checkdbAction()
    {
        ...
        if(! $oRequest->isPost()) {
            ...
            return new ViewModel([
                ...
                'sVendor' => 'oneplace',
                'sModule' => 'oneplace-event-ticket',
            ]);
        } else {
            $sSetupConfig = $oRequest->getPost('plc_module_setup_config');

            $sSetupFile = 'vendor/oneplace/oneplace-event-ticket/data/install.sql';
            ...
            if($sSetupConfig != '') {
                $sConfigStruct = 'vendor/oneplace/oneplace-event-ticket/data/structure_'.$sSetupConfig.'.sql';
                ...
                $sConfigData = 'vendor/oneplace/oneplace-event-ticket/data/data_'.$sSetupConfig.'.sql';
            ...
            $oModTbl->insert([
                'module_key' => 'oneplace-event-ticket',
                'type' => 'plugin',
                'version' => \OnePlace\Event\Ticket\Module::VERSION,
                'label' => 'onePlace Event Ticket',
                'vendor' => 'oneplace',
            ]);
            ...
            $this->flashMessenger()->addSuccessMessage('Event Ticket DB Update successful');
